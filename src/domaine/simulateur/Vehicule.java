...
public class Vehicule {
	...
	private void resteEnEtatDAttente(){
		// ici le vehicule vŽrifie d'abord si sa stratŽgie est de retourner au port d'attache.
		// Si c'est le cas, il vŽrifie s'il est au port d'attache, si oui, il ne fait rien
		// Sinon il rentre au port.
		// Si jamais sa stratŽgie n'est pas de retournŽ au port d'attache, il reste sur place
	...
	private void declencherMission(){
		...
		Arc arc = new Arc(m_noeudActuel, noeud); // Pour des raisons de calcul, on crŽe un nouvel arc
