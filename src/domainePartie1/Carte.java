...
public class Carte {
	...
	public void ajouterArc(Noeud noeudSource, Noeud noeudDest) {
		if (this.m_listeDeNoeuds.contains(noeudSource)
			...
			this.m_listeDeNoeuds.get(index).reqListeArcsAdjacents()
					.add(nouvelArc);
		}
	...
	public void enleverNoeud(Noeud noeud) {
		if (this.m_listeDeNoeuds.contains(noeud)) {
			this.m_listeDeNoeuds.get(this.m_listeDeNoeuds.indexOf(noeud))
					.reqListeArcsAdjacents().clear();// enlever la liste des
														// noeuds adjacents
