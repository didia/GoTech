...
public class InterfaceGraphique extends JFrame implements ActionListener,
	...
	private static String ADD_PARAMETRES = "Paramï¿½tres de Simulation";
	...
	public InterfaceGraphique(Simulateur p_simulateur,
		...
		iconSelect
				.setToolTipText("Modifier et Dï¿½placer des noeuds et des arcs");
		...
		JButton iconAjoutVehicule = new JButton(reqResizedIcon(iconVehicule,
				20, 20));
		iconAjoutVehicule
				.setToolTipText("Placer Vï¿½hicule d'urgence sur un port d'attache");
		...
		JButton iconAddSettings = new JButton(reqResizedIcon(iconSettings, 20,
				20));
		iconAddSettings
				.setToolTipText("Modifier les paramï¿½tres de la simulation");
