...
public class ParametrePanel extends JPanel {
	...
	public ParametrePanel(Simulateur simulateur) {
		...
		rdbtnParProximit.setToolTipText("Les urgences sont traitées par ordre de proximitŽ");
		...
		JCheckBox chckbxVhiculeRetourneAu = new JCheckBox("Retour au point d'attache aprés traitement des urgences");
